...
public class LunarUtils {
     ...
     */
    public static int jdFromDate(int dd, int mm, int yy) //đổi ngày sang số
    {
        int a = (14 - mm) / 12;
        int y = yy + 4800 - a;
        int m = mm + 12 * a - 3;
    ...
    public static int getLeapMonthOffset(int a11, double timeZone) // Tinh thang nhuan
    {
     ...
     */
    public static int[] convertSolar2Lunar(int dd, int mm, int yy, double timeZone) // DƯƠNG SANG ÂM
    {
    ...
    public static int[] convertLunar2Solar(int lunarDay, int lunarMonth, int lunarYear, int lunarLeap, double timeZone) //ÂM SANG DƯƠNG
    {
        int a11, b11;
        if (lunarMonth < 11) {
