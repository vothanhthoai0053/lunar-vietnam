...
public class SystemTrayUtils {
    ...
    public static void initialSystemTray(BufferedImage image, final Window calendarWiget) {
        ...
        System.out.println("com.htmz.lichvn.utils.SystemTrayUtils.initialSystemTray() " + trayIconWidth);

//setting tray icon
        TrayIcon trayIcon = new TrayIcon(image.getScaledInstance(trayIconWidth, -1, Image.SCALE_SMOOTH), "Lịch Việt Nam", trayPopupMenu);
